...
AR Path="/5A053B90/5A020365" Ref="R?"  Part="1" 
AR Path="/5A050A02/5A020365" Ref="R?"  Part="1" 
...
AR Path="/5A053B90/5A0203AA" Ref="R?"  Part="1" 
AR Path="/5A050A02/5A0203AA" Ref="R?"  Part="1" 
...
AR Path="/5A053B90/5A020460" Ref="D?"  Part="1" 
AR Path="/5A050A02/5A020460" Ref="D?"  Part="1" 
...
AR Path="/5A053B90/5A020509" Ref="D?"  Part="1" 
AR Path="/5A050A02/5A020509" Ref="D?"  Part="1" 
...
AR Path="/5A053B90/5A04F122" Ref="#PWR?"  Part="1" 
AR Path="/5A050A02/5A04F122" Ref="#PWR?"  Part="1" 
...
AR Path="/5A053B90/5A04FD15" Ref="#PWR?"  Part="1" 
AR Path="/5A050A02/5A04FD15" Ref="#PWR?"  Part="1" 
...
AR Path="/5A053B90/5A04FCD5" Ref="#PWR?"  Part="1" 
AR Path="/5A050A02/5A04FCD5" Ref="#PWR?"  Part="1" 
...
F 3 "https://www.vishay.com/docs/91301/91301.pdf" H 3550 2850 50  0001 L CNN
	1    3550 2850
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5A0A33AC
P 3350 1150
F 0 "D?" H 3350 1366 50  0000 C CNN
F 1 "D" H 3350 1275 50  0000 C CNN
...
Text Notes 2300 1350 0    28   ~ 0
Absorbs voltage spikes from inductance in connecting wires.\nMind effect of leakage current.
Text Notes 2050 3300 0    28   ~ 0
Keeps FET off if disconnected, preventing \ngate from accumulating charge.
Text Notes 2000 3000 0    28   ~ 0
Limits FET switching time to recommended.
Text Notes 3700 2450 0    28   ~ 0
Limits current through clamp diode, dissipating \npower, in persistent overvoltage (short) condition.
Text Notes 4800 2150 0    28   ~ 0
Clamps output voltage to Vcc. Mind leakage.
Text Notes 2650 2050 0    28   ~ 0
