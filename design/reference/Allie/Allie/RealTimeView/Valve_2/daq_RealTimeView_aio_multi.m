...
stimname1 = '2secON_2secOFF_1minDUR.mat';
stimname2 = '3secON_3secOFF_1minDUR.mat';
stimname3 = '0secON_1secOFF_1minDUR.mat';
stimname4 = '0secON_1secOFF_1minDUR.mat';
...
params1 = struct('odor',odor,'concentration',concentration,...
    'fly',fly,'notes',notes,'rate_Hz',rate,'stimname1',stimname1);
params2 = struct('odor',odor,'concentration',concentration,...
    'fly',fly,'notes',notes,'rate_Hz',rate,'stimname2',stimname2);
params3 = struct('odor',odor,'concentration',concentration,...
    'fly',fly,'notes',notes,'rate_Hz',rate,'stimname3',stimname3);
params4 = struct('odor',odor,'concentration',concentration,...
    'fly',fly,'notes',notes,'rate_Hz',rate,'stimname4',stimname4);
...
for acquire_loop = 1:trials
    ...
    s.queueOutputData([stim1 stim2 stim3 stim4]); %how to get different stimuli?
    disp(['Expt started ',char(datetime)]);
    disp(['Will run for ',num2str(length(stim1)/rate/3600*trials),' hours']);
